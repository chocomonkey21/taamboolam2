...
export const en: Content = {
  ...
  photoViewer: {
    enlarge: "View this photograph larger",
    close: "Close",
  },
  ...
  about: {
    ...
    plateLabel:
      "A taamboolam tray: betel leaves, a coconut, bananas, areca nut, and small heaps of turmeric and kumkum.",
    nameBody: [
  ...
  experience: {
    ...
    close: {
      heading: "That is the house",
      body: "If you have read this far, you probably already know whether it suits you. Write to us and tell us who is coming.",
    },
  },
  ...
  form: {
    ...
    messageHint:
      "Who is coming, what you are hoping for, anything we should plan around.",
    gatheringDetails: "Tell us about the gathering",
    gatheringHint:
      "What kind of gathering, roughly how long it would run, and anything else that matters.",
    whatsappConsent: "You may contact me on WhatsApp",
    optional: "Optional",
    required: "Required",
    ...
    successBody:
      "Your enquiry has reached the Taamboolam team. The owner will reply personally, usually within 24–48 hours.",
    ...
    errors: {
      ...
      phoneMissing: "Please give us a phone number.",
      phoneShort: "That phone number looks too short.",
      arrival: "Please tell us when you would arrive.",
      departure: "Please tell us when you would leave.",
      departureOrder: "The day you leave should come after the day you arrive.",
      adults: "Please tell us how many adults are coming.",
      adultsRange: "Please enter a number between 1 and 30.",
      children: "Please enter a number, or 0 if none.",
      childrenRange: "Please enter a number between 0 and 30.",
      gatheringDetails: "Please tell us a little about the gathering.",
      tooLong: "That is very long. Please shorten it a little.",
    },
  },
};
